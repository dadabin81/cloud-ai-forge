            ...
            <CardContent className="prose prose-invert max-w-none p-8">
              <div className="space-y-8 text-foreground">
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Our Services may integrate with third-party AI providers (OpenAI, Anthropic, Google, etc.). 
                    Your use of these providers through our Services is also subject to their respective terms 
                    of service and privacy policies. We are not responsible for the content or practices of 
